...
. Return the previous steps and change the provisioned throughput from 50 MiB/s to 200 MiB/s.
...
image::throughput-dd.png[link=../04-iops-4kb/, align="left",width=420]
