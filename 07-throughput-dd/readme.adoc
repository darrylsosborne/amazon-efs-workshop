...
[width="50",cols="<1,^1,^1,^1,^1,^1",options="header,strong"]
|==============================================================================================
a| Storage | Threads | Data size (MB) | Block size (MB) | Duration (seconds) | Throughput (MB/s)
a| EBS     | 1       | 2048           | 1               | 15.002             | 136.5
a| EFS     | 1       | 2048           | 1               | 86.699             | 23.6
a| EBS     | 1       | 2048           | 16              | 15.002             | 136.5
a| EFS     | 1       | 2048           | 16              | 30.574             | 67.0
a| EBS     | 4       | 2048           | 1               | 15.083             | 135.8
a| EFS     | 4       | 2048           | 1               | 23.292             | 87.9
a| EBS     | 16      | 2048           | 1               | 15.093             | 135.7
a| EFS     | 16      | 2048           | 1               | 10.581             | 193.6
|==============================================================================================
...
image::throughput-dd.png[link=../08-throughput-ior, align="left",width=420]
