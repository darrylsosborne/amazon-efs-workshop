...
* The following table and graph shows the sample results of a few tests. Look how increasing the number of threads (parallelism) and writing to different subdirectories (decreasing inode contention) impacts the results.
...
image::iops-4kb-iops-graph.png[align="left", width=600]
image::iops-4kb-duration-graph.png[align="right", width=600]
